...
const HomeBtns = ({ lang }: Props) => {
	let ES_URL = 'https://drive.google.com/file/d/1HQ68NzJFhppVZnWBYzUB2fV00ZgWZk8n/view?usp=sharing';
	let EN_URL = 'https://drive.google.com/file/d/1HQ68NzJFhppVZnWBYzUB2fV00ZgWZk8n/view?usp=sharing';
